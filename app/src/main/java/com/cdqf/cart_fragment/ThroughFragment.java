...
public class ThroughFragment extends Fragment {
    ...
    private String TAG = ThroughFragment.class.getSimpleName();
    ...
    private void initAdapter() {
        throughAccountAdapter = new ThroughAccountAdapter(getContext());
        lvServiceList.setAdapter(throughAccountAdapter);
    }
