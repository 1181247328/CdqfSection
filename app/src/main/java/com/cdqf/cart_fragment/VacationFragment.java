...
import com.cdqf.cart_adapter.VacationAdapter;
...
public class VacationFragment extends Fragment {
    ...
    private String TAG = VacationFragment.class.getSimpleName();
    ...
    private VacationAdapter vacationAdapter = null;
            ...
            public void onLoadMore(final PullToRefreshLayout pullToRefreshLayout) {
                ...
                okHttpRequestWrap.post(CartAddaress.EMPLOYEES, false, "请稍候", params, new OnHttpRequest() {
                    ...
                    public void onOkHttpResponse(String response, int id) {
                        Log.e(TAG, "---onOkHttpResponse---休假---" + response);
                        ...
                        switch (error_code) {
                            ...
                            case 200:
                                ...
                                List<Vaction> vactionList = gson.fromJson(datas, new TypeToken<List<Vaction>>() {
                                }.getType());
                                cartState.getVactionList().addAll(vactionList);
    ...
    private void initAdapter() {
        vacationAdapter = new VacationAdapter(getContext());
        lvAllemployeesList.setAdapter(vacationAdapter);
    }
...
//        //页码
//        params.put("page", page);
        okHttpRequestWrap.post(CartAddaress.EMPLOYEES, isToast, "请稍候", params, new OnHttpRequest() {
            @Override
            public void onOkHttpResponse(String response, int id) {
                Log.e(TAG, "---onOkHttpResponse---休假---" + response);
                JSONObject resultJSON = JSON.parseObject(response);
                ...
                switch (error_code) {
                    ...
                    case 200:
                        ...
                        cartState.getVactionList().clear();
                        cartState.initToast(getContext(), msg, true, 0);
                        eventBus.post(new EmployeesPullFind(false, true));
                        List<Vaction> vactionList = gson.fromJson(datas, new TypeToken<List<Vaction>>() {
                        }.getType());
                        cartState.setVactionList(vactionList);
                        if(cartState.getVactionList().size()<=0){
                            rlOrdersBar.setVisibility(View.GONE);
    ...
    @Subscribe
    public void onEventMainThread(VacationPullFind a) {
        page = 1;
        initPull(false);
    }
}