...
import com.cdqf.cart_adapter.WithdrawsAdapter;
...
public class WithdrawsFragment extends Fragment {
    ...
    private String TAG = WithdrawsFragment.class.getSimpleName();
    ...
    private WithdrawsAdapter withdrawsAdapter = null;
    ...
    private void initAdapter() {
        withdrawsAdapter = new WithdrawsAdapter(getContext());
        lvServiceList.setAdapter(withdrawsAdapter);
    }
