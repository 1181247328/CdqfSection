                    ...
                    public void onOkHttpResponse(String response, int id) {
                        ...
                        switch (error_code) {
                            ...
                            case 200:
                                ...
                                List<Moth> mothList = gson.fromJson(datas, new TypeToken<List<Moth>>() {
                                }.getType());
                                cartState.getMothList().addAll(mothList);
            ...
            public void onOkHttpResponse(String response, int id) {
                ...
                switch (error_code) {
                    ...
                    case 200:
                        ...
                        cartState.setMothList(mothList);

                        if (cartState.getMothList().size() <= 0) {
                            rlOrdersBar.setVisibility(View.GONE);
                            ptrlDailyPull.setVisibility(View.GONE);
                            tvOrdersAbnormal.setVisibility(View.VISIBLE);
                        }
