 ...
 * 全部员工适配器
 */
public class AllemployeesAdapter extends BaseAdapter {

    private String TAG = AllemployeesAdapter.class.getSimpleName();
    ...
    public AllemployeesAdapter(Context context) {
